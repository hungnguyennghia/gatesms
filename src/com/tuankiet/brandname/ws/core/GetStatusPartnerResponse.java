...
@XmlRootElement(name = "getStatusPartnerResponse")
public class GetStatusPartnerResponse {

    @XmlElementRef(name = "return", namespace = "http://core.ws.brandname.tuankiet.com", type = JAXBElement.class)
