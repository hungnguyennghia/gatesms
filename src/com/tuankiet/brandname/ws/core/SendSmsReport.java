...
@XmlRootElement(name = "sendSmsReport")
public class SendSmsReport {
    ...
    @XmlElementRef(name = "partnerId", namespace = "http://core.ws.brandname.tuankiet.com", type = JAXBElement.class)
    ...
    public void setPartnerId(JAXBElement<String> value) {
        this.partnerId = ((JAXBElement<String> ) value);
    }
